...
with st.chat_message('ReubenGPT', avatar = '🤖'):
    st.markdown("""Hi, I am ReubenGPT, Reuben's slave. This is not an actual bot. 
                We are a team of 3 actual people working in 8-hour shifts hoping that Reuben will notice us and make us his girlfriends. 
                What is your name? And what do you want to kaypoh about?
                """)
